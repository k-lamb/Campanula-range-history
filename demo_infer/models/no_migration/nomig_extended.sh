#!/usr/bin/bash
#SBATCH -J nomig # A single job name for the array
#SBATCH -n 1
#SBATCH -t 24:00:00
#SBATCH --mem=8G
#SBATCH -o /scratch/ksl2za/demo_infer/no_migration/out/nomig_out_%j.txt
#SBATCH -e /scratch/ksl2za/demo_infer/no_migration/error/nomig_error_%j.txt
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-49 nomig_extended.sh
...
cd /scratch/ksl2za/demo_infer/no_migration
python nomig_extended.py \
$iter \
$Pair \
$pop1 \
$pop2 \
