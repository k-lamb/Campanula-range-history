#!/usr/bin/bash
#SBATCH -J mig2C_80 # A single job name for the array
#SBATCH -n 1
#SBATCH -t 120:00:00
#SBATCH --mem=8G
#SBATCH -o /scratch/ksl2za/demo_infer/80_linreg_2c/migration/out/mig_out_%j.txt
#SBATCH -e /scratch/ksl2za/demo_infer/80_linreg_2c/migration/error/mig_error_%j.txt
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-3 2c_mig_extended.sh
...
metadata=/scratch/ksl2za/demo_infer/80_linreg_2c/All_metadat_80_linreg.txt #Address to the metadata. 
...
cd /scratch/ksl2za/demo_infer/80_linreg_2c/migration
python 2c_mig_extended.py \
$iter \
$Pair \
$pop1 \
$pop2 \
