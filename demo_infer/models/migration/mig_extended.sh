#!/usr/bin/bash
#SBATCH -J mig # A single job name for the array
#SBATCH -n 1
#SBATCH -t 168:00:00
#SBATCH --mem=8G
#SBATCH -o /scratch/ksl2za/demo_infer/migration/out/mig_out_%j.txt
#SBATCH -e /scratch/ksl2za/demo_infer/migration/error/mig_error_%j.txt
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-49 mig_extended.sh
...
cd /scratch/ksl2za/demo_infer/migration
python mig_extended.py \
$iter \
$Pair \
$pop1 \
$pop2 \
