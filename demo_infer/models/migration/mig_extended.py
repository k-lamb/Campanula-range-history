...
dd = dadi.Misc.make_data_dict_vcf("/scratch/ksl2za/demo_infer/noTperf_65miss_50miss_FULL.recode.vcf", "/scratch/ksl2za/demo_infer/vcf_popmap.txt")
...
model_list = [IM, IM_b, IM_br, IM_ae, IM_ae_b, IM_ae_br]
