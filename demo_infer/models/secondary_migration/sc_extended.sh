#!/usr/bin/bash
#SBATCH -J sc # A single job name for the array
#SBATCH -n 1
#SBATCH -t 168:00:00
#SBATCH --mem=8G
#SBATCH -o /scratch/ksl2za/demo_infer/secondary_migration/out/sc_out_%j.txt
#SBATCH -e /scratch/ksl2za/demo_infer/secondary_migration/error/sc_error_%j.txt
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-49 sc_extended.sh
...
metadata=/scratch/ksl2za/demo_infer/All_metadat.txt #Address to the metadata. 
...
cd /scratch/ksl2za/demo_infer/secondary_migration
python sc_extended.py \
$iter \
$Pair \
$pop1 \
$pop2 \
