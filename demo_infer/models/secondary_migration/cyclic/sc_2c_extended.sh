#!/usr/bin/bash
#SBATCH -J sc2C_65 # A single job name for the array
#SBATCH -n 1
#SBATCH -t 120:00:00
#SBATCH --mem=8G
#SBATCH -o /scratch/ksl2za/demo_infer/65_linreg_2c/secondary_migration/out/sc_out_%j.txt
#SBATCH -e /scratch/ksl2za/demo_infer/65_linreg_2c/secondary_migration/error/sc_error_%j.txt
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-3 sc_extended.sh
...
cd /scratch/ksl2za/demo_infer/65_linreg_2c/secondary_migration
python sc_2c_extended.py \
$iter \
$Pair \
$pop1 \
$pop2 \
