#!/usr/bin/bash
#SBATCH -J amsc_65 # A single job name for the array
#SBATCH -n 1
#SBATCH -t 120:00:00
#SBATCH --mem=8G
#SBATCH -o /scratch/ksl2za/demo_infer/65_linreg_2c/ancient_secondary_migration/out/amsc_out_%j.txt
#SBATCH -e /scratch/ksl2za/demo_infer/65_linreg_2c/ancient_secondary_migration/error/amsc_error_%j.txt
#SBATCH -p standard
#SBATCH -a lfg_lab

### sbatch --array=1-3 amsc_extended.sh
...
metadata=/scratch/ksl2za/demo_infer/65_linreg_2c/All_metadat_65_linreg.txt #Address to the metadata. 
...
cd /scratch/ksl2za/demo_infer/65_linreg_2c/ancient_secondary_migration
python amsc_extended.py \
$iter \
$Pair \
$pop1 \
$pop2 \
